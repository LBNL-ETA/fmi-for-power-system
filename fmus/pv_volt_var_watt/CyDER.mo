...
changed to parameters.
      ...
      model voltVarWatt_param_firstorder
        ...
        voltVar_param_firstorder voltWatt(
        ...
        voltVar_param_firstorder voltVar(
          thr=thrQ,
          hys=hysQ,
          QMaxInd=QMaxInd,
          QMaxCap=QMaxCap,
    ...
    package Examples
      ...
      model Validate_VoltVarControl_param
        ...
        Modelica.Blocks.Sources.Ramp ramp(
          ...
          offset=0.9)
          annotation (Placement(transformation(extent={{-90,-10},{-70,10}})));
        HIL.Controls.voltVar_param voltVar_param
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      equation
      ...
      model Validate_VoltVarWattControl
        Modelica.Blocks.Sources.Ramp ramp(
          ...
          offset=0.9)
          annotation (Placement(transformation(extent={{-90,-10},{-70,10}})));
        Controls.voltVarWatt_param_firstorder voltVarWatt_param_firstorder(
            Tfirstorder=0.001)
