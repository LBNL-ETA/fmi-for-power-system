...
///////////// THE CODE BELOW HAS BEEN AUTOGENERATED //////////////
  Modelica.Blocks.Interfaces.RealInput a(start=0.0, unit="m")
    "input 1" annotation(Placement(transformation(extent={{-122,68},{-100,90}})));
  Modelica.Blocks.Interfaces.RealInput b(start=0.0, unit="m")
    "input 2" annotation(Placement(transformation(extent={{-122,48},{-100,70}})));
  Modelica.Blocks.Interfaces.RealOutput r (unit="m")
    "result" annotation(Placement(transformation(extent={{100,70},{120,90}})));
  // Edited by Christoph on 12/06/2018 //	
  Modelica.Blocks.Continuous.FirstOrder r_transfer (T=Tfirstorder);
    /*"result" annotation(Placement(transformation(extent={{100,70},{120,90}})));*/
  // End //
  // Configuration specific parameters coming from
  // the inputs of the Python export tool (SimulatorToFMU.py)
  parameter String patResScri = Modelica.Utilities.Files.loadResource("C:\\Users\\DRRC\\Desktop\\fmi-for-power-system\\fmus\\simple_func\\simple_wrapper.py")
...
///////////// THE CODE ABOVE HAS BEEN AUTOGENERATED //////////////
  protected
    parameter String moduleName="simple_wrapper"
  ...
  // Edited by Christoph on 12/06/2018 //
	...
	r_transfer.u = dblOutVal[1];
	
	connect(r_transfer.y, r);
  // End //
end simple;