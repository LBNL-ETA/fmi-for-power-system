...
///////////// THE CODE BELOW HAS BEEN AUTOGENERATED //////////////
  parameter String _configurationFileName = "C:\\Users\\DRRC\\Desktop\\fmi-for-power-system\\tests\\001_load_and_simulate\\ME_function\\csv_reader\\data.csv"
    "parameter";
  ...
  parameter String patResScri = Modelica.Utilities.Files.loadResource("C:\\Users\\DRRC\\Desktop\\fmi-for-power-system\\tests\\001_load_and_simulate\\ME_function\\csv_reader\\jonathan_wrapper.py")
    "Path to the script in resource folder";
  // used to generate the FMU
  //
  //parameter String _configurationFileName = Modelica.Utilities.Files.loadResource("C:\\Users\\DRRC\\Desktop\\fmi-for-power-system\\tests\\001_load_and_simulate\\ME_function\\csv_reader\\data.csv")
...
///////////// THE CODE ABOVE HAS BEEN AUTOGENERATED //////////////
  protected
    parameter String moduleName="jonathan_wrapper"
