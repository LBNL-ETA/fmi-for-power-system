...
///////////// THE CODE BELOW HAS BEEN AUTOGENERATED //////////////
  parameter String _configurationFileName = "Not used here"
    "parameter";
  ...
  Modelica.Blocks.Interfaces.RealInput KW_8(start=0.0, unit="kW")
    "input" annotation(Placement(transformation(extent={{-122,28},{-100,50}})));
  Modelica.Blocks.Interfaces.RealInput KVAR_8(start=0.0, unit="kVAR")
    "input" annotation(Placement(transformation(extent={{-122,8},{-100,30}})));
  Modelica.Blocks.Interfaces.RealInput KW_9(start=0.0, unit="kW")
    "input" annotation(Placement(transformation(extent={{-122,-12},{-100,10}})));
  Modelica.Blocks.Interfaces.RealInput KVAR_9(start=0.0, unit="kVAR")
    "input" annotation(Placement(transformation(extent={{-122,-32},{-100,-10}})));
  Modelica.Blocks.Interfaces.RealOutput Vpu_7 (unit="1")
    "output" annotation(Placement(transformation(extent={{100,70},{120,90}})));
  Modelica.Blocks.Interfaces.RealOutput Vpu_8 (unit="1")
    "output" annotation(Placement(transformation(extent={{100,52},{120,72}})));
  Modelica.Blocks.Interfaces.RealOutput Vpu_9 (unit="1")
    "output" annotation(Placement(transformation(extent={{100,34},{120,54}})));
  Modelica.Blocks.Interfaces.RealOutput Vpu_16 (unit="1")
    "output" annotation(Placement(transformation(extent={{100,16},{120,36}})));
  Modelica.Blocks.Interfaces.RealOutput Vpu_17 (unit="1")
    "output" annotation(Placement(transformation(extent={{100,-2},{120,18}})));
  Modelica.Blocks.Interfaces.RealOutput Vpu_30 (unit="1")
    "output" annotation(Placement(transformation(extent={{100,-20},{120,0}})));
  Modelica.Blocks.Interfaces.RealOutput Vpu_31 (unit="1")
    "output" annotation(Placement(transformation(extent={{100,-38},{120,-18}})));
  Modelica.Blocks.Interfaces.RealOutput Vpu_32 (unit="1")
    "output" annotation(Placement(transformation(extent={{100,-56},{120,-36}})));
  // Configuration specific parameters coming from
  // the inputs of the Python export tool (SimulatorToFMU.py)
  parameter String patResScri = Modelica.Utilities.Files.loadResource("C:\\Users\\DRRC\\Desktop\\fmi-for-power-system\\tests\\009_pandapower_MEloop\\pandapower\\pandapower_wrapper.py")
