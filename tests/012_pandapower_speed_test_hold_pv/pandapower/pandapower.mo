...
///////////// THE CODE BELOW HAS BEEN AUTOGENERATED //////////////
  ...
  // Edited by Christoph on 12/06/2018 //	
  Modelica.Blocks.Continuous.FirstOrder Vpu_9_transfer (T=Tfirstorder);
    /*"Voltage at node X" annotation(Placement(transformation(extent={{100,52},{120,72}})));*/
  // End //
  ...
  // Edited by Christoph on 12/06/2018 //	
  Modelica.Blocks.Continuous.FirstOrder Vpu_24_transfer (T=Tfirstorder);
    /*"Voltage at node X" annotation(Placement(transformation(extent={{100,34},{120,54}})));*/
  // End //
  // Configuration specific parameters coming from
  // the inputs of the Python export tool (SimulatorToFMU.py)
  parameter String patResScri = Modelica.Utilities.Files.loadResource("C:\\Users\\DRRC\\Desktop\\fmi-for-power-system\\tests\\012_pandapower_speed_test_hold_pv\\pandapower\\pandapower_wrapper.py")
...
///////////// THE CODE ABOVE HAS BEEN AUTOGENERATED //////////////
  ...
  // Edited by Christoph on 12/06/2018 //
	...
	Vpu_9_transfer.u = dblOutVal[2];
	Vpu_24_transfer.u = dblOutVal[3];
	
	connect(Vpu_7_transfer.y, Vpu_7);
	connect(Vpu_9_transfer.y, Vpu_9);
	connect(Vpu_24_transfer.y, Vpu_24);
  // End //
end pandapower;